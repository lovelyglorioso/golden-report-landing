  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div 
        ...
        style={{ backgroundImage: `url(${miningBackground})` }}
      >
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xs text-foreground/80 mb-4 max-w-4xl mx-auto leading-relaxed">
      ...
      {/* Scroll Indicator */}
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-foreground/70 animate-bounce">
